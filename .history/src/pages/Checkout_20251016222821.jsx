    ...
    {cartItems.length > 0 ? (
      cartItems.map((product) => (
        <Link
          ...
          className="group flex flex-col sm:flex-row sm:items-center sm:justify-between border-b last:border-0 pb-3 gap-3 hover:bg-gray-100 rounded-md transition"
        >
