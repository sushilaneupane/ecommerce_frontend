  ...
  >
    <ArrowLeft size={20} />
      ...
      <div className="flex flex-col lg:flex-row lg:gap-1 max-w-6xl w-full">
       ...
       <Card className="lg:w-1/2 flex flex-col bg-gray-800 justify-center items-center p-0">
  <div className="w-full h-64 sm:h-80 md:h-[60vh] lg:h-[70vh] bg-red-800 overflow-y-auto">
            <img
              src={selectedImage}
